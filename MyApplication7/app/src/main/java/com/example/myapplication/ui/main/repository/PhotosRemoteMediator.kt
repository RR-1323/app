...
class PhotosRemoteMediator(val application: Application): RemoteMediator<Int, PhotoEntity>() {
    /*
...
val photoRemoteRepository = PhotoRemoteRepositoryImpl(application)
    ...
    override suspend fun load(
        ...
        return try {
            val response = photoRemoteRepository.checkRequester( pageIndex).toListEntity()
